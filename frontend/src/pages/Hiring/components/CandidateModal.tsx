...
export default function CandidateModal({ candidate, onClose, onUpdate, onReject }: Props) {
    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-fade-in" onClick={onClose}>
            <div className="bg-white dark:bg-[#1e293b] w-full max-w-4xl h-[90vh] rounded-2xl shadow-2xl border border-white/10 flex flex-col overflow-hidden" onClick={e => e.stopPropagation()}>
                ...
                <div className="flex-1 overflow-y-auto p-8 bg-gray-100/50 dark:bg-[#0f172a]/50 custom-scrollbar">
                    {activeTab === 'overview' && (
