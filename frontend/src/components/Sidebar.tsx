...
import { 
  ...
  CurrencyDollar, TrendUp, Globe, HardDrives, Gear,
  Kanban 
  ...
  return (
    <aside className="h-full flex flex-col items-center py-6 border-r z-50 overflow-visible bg-[var(--color-sidebar)] border-[var(--color-border)] w-[80px]">
      ...
      <div className="flex-col gap-4 mt-auto flex items-center pb-2">
          {/* Theme Toggle Removed - Now in Admin Panel */}
          <button onClick={signOut} className="nav-item text-[var(--color-danger)] hover:text-[var(--color-danger)] hover:bg-[var(--color-danger-bg)] group relative" title="Sign Out">
